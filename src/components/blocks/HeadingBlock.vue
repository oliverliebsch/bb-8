<template>
  <div class="bb8-block">
    <input :value="block.fields[0].content" @blur="updateText($event)" @keyup.delete="removeBlock($event)" class="bb8-form-control bb8-block-headline" placeholder="…" required>
